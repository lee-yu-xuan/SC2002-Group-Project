                        ...
                        if (bookingHistory != null) {
                            ...
                            if (upcomingBooking == null) {
                                ...
                                for (int i = 0; i < upcomingBooking.size(); i++) {
                                    System.out.println("You have a movie: "
                                            + MovieListing.getMovieName(upcomingBooking.get(i).getmovieID()) + " at "
                                            + upcomingBooking.get(i).getDateTime() + " and your seat number is "
                                            + upcomingBooking.get(i).getSeats());
                                }
                            }
                            System.out.println("\n");
                            ...
                            if (pastBooking == null) {
                                ...
                                for (int i = 0; i < pastBooking.size(); i++) {
                                    System.out.println("You have a movie: "
                                            + MovieListing.getMovieName(pastBooking.get(i).getmovieID()) + " at "
                                            + pastBooking.get(i).getDateTime() + " and your seat number is "
                                            + pastBooking.get(i).getSeats());
                                }
                            }
                        } else {
